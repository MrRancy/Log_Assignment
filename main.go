...
func main() {
	...
	postEndpoint := utils.GetEnv("POST_ENDPOINT", "https://httpdump.app/dumps/8e06d9f6-ac86-4629-a13b-f2d802a24fbe2")

	// Creating In Memory store
	cache := store.NewCache(log, postEndpoint, batchInterval, batchSize, 2, 2)
